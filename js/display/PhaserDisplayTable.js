class PhaserDisplayTable extends EowDisplayTable {
    ...
    constructor(/** @type {EowScene} */scene, /** @type {EowTable} */table) {
        super();
        this.#scene = scene;
        this.#table = table;
    }
    ...
    create() {
        this.#tableRectangle = this.#scene.add
            ...
            .setVisible(true);
        this.#leftDeploymentZone = this.#scene.add
        ...
        this.#leftDeploymentZone.setInteractive(this.#leftDeploymentZone.getBounds(), Phaser.Geom.Rectangle.Contains)
            .disableInteractive();
        this.#rightDeploymentZone = this.#scene.add
        ...
        this.#rightDeploymentZone.setInteractive(this.#leftDeploymentZone.getBounds(), Phaser.Geom.Rectangle.Contains)
            .disableInteractive();
        this.#pickLeftDeploymentZoneText = this.#scene.add
        ...
        this.#pickRightDeploymentZoneText = this.#scene.add
            .text(0, 0, $.i18n('pick-side-of-table'), { color: '#000', fontSize: 75, wordWrap: { width: EowSize.TABLE_SHORT_EDGE * DisplaySize.INCH } })
            .setAngle(90)
            .setOrigin(0, 1)
            .setVisible(false);
